...
public final class HelloWorldGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.grpc.api.Helloworld.HelloRequest,
      com.grpc.api.Helloworld.HelloResponse> METHOD_HELLO =
      io.grpc.MethodDescriptor.<com.grpc.api.Helloworld.HelloRequest, com.grpc.api.Helloworld.HelloResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "api.HelloWorld", "Hello"))
          .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.grpc.api.Helloworld.HelloRequest.getDefaultInstance()))
          .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
              com.grpc.api.Helloworld.HelloResponse.getDefaultInstance()))
          .build();
  ...
  public static abstract class HelloWorldImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void hello(com.grpc.api.Helloworld.HelloRequest request,
        io.grpc.stub.StreamObserver<com.grpc.api.Helloworld.HelloResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.grpc.api.Helloworld.HelloRequest,
                com.grpc.api.Helloworld.HelloResponse>(
                  this, METHODID_HELLO)))
          .build();
    }
  }
  ...
  public static final class HelloWorldBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldBlockingStub> {
    ...
    /**
     */
    public com.grpc.api.Helloworld.HelloResponse hello(com.grpc.api.Helloworld.HelloRequest request) {
  ...
  public static final class HelloWorldFutureStub extends io.grpc.stub.AbstractStub<HelloWorldFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.grpc.api.Helloworld.HelloResponse> hello(
        com.grpc.api.Helloworld.HelloRequest request) {
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_HELLO:
          serviceImpl.hello((com.grpc.api.Helloworld.HelloRequest) request,
              (io.grpc.stub.StreamObserver<com.grpc.api.Helloworld.HelloResponse>) responseObserver);
          break;
        default:
  ...
  private static final class HelloWorldDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.grpc.api.Helloworld.getDescriptor();
    }
  }
